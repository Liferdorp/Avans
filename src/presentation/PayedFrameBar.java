            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (firstName == "Patrick") {
                    ...
                    if (connection.openConnection()) {
                        ...
                        resultset = connection.executeSqlDmlStatement("UPDATE barorder SET statusId=6, employeeId='" + employeeId + "' where id='" + orderID + "' ;");
                        frame.dispose();
