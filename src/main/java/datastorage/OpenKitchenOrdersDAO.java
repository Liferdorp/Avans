                ...
                if (resultset != null) {
                    try {
                        while (resultset.next()) {
                            ...
                            OpenKitchenOrder newOpenKitchenOrder = new OpenKitchenOrder(status, tableNr, dishName, quantity, kitchenOrderId, statusName, restaurantOrderId, kitchenOrderPrice);
