...
public class DeliveredFrameKitchen {
    ...
    private final JFrame frame = new JFrame("Bezorgd melden keuken bestellingen");
            ...
            try {
                ...
                if (ID > 0) {
                    ...
                    while (rs2.next()) {
                        ...
                        String statement = updateStatusSQL.sqlUpdateDeliveredKitchen(employeeId, ID);
