...
public class ReceiptFrame {
    ...
    private static final JTextField input1 = new JTextField();
                ...
                while (rs.next()) {
                    ...
                    if (orderID > 0) {
                        ...
                        for (int i = 0; i < kitchenOrders.size(); i++) {
                            if (orderID == kitchenOrders.get(i).getRestaurantOrderId()) {
