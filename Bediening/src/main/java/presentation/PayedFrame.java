...
public class PayedFrame {
    ...
    private JFrame frame = new JFrame("Betaald melden ");
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (firstName == "Jessie") {
                    ...
                    if (connection.openConnection()) {
                        ...
                        resultset = connection.executeSqlDmlStatement("UPDATE `restaurantorder`,`receipt` SET `restaurantorder`.`statusId`=6, `receipt`.`employeeId`= " + employeeId + " where `restaurantorder`.`id`= " + orderID + " ;");
                        frame.dispose();
                        frame.setVisible(false);
                        ScreenInfoFrame ui = new ScreenInfoFrame();
                        ui.setVisible(true);
